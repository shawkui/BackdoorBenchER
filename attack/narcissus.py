'''
this script is for narcissus attack
...
To run the script, you need create the required resource in resource/narcissus/trigger.npy which contains the trigger for backdoor attack.
Such sample can be generated by scripts in the official code of Narcissus attack: https://github.com/reds-lab/Narcissus
...
class narcissus(BadNet):
    ...
    def set_bd_args(cls, parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
        ...
        parser.add_argument("--attack_train_narcissus_alpha", type=float, )
        parser.add_argument("--attack_test_narcissus_alpha", type=float, )
