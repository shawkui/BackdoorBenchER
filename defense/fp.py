...
class FinePrune(defense):
    ...
    def process_args(self, args):
        ...
        defense_save_path = "record" + os.path.sep + args.result_file + os.path.sep + "defense" + os.path.sep + "fp" + os.path.sep  + f'{self.args.yaml_name}/'
    ...
    def defense(self):
        ...
        self.args.log = args.defense_save_path + os.path.sep
        self.result = attack_result
        train_tran = get_transform(self.args.dataset, *([self.args.input_height,self.args.input_width]) , train = True)
        clean_train_dataset_with_transform = self.get_reserved_data(train_tran, reserved_type = self.args.reserved_type, ratios = None)
        ...
        with torch.no_grad():
            ...
            for batch_idx, (inputs, *other) in enumerate(trainloader):
                ...
                if flag == 0:
                    ...
                    flag = 1
                activation += torch.sum(result_mid, dim=[0]) / len(clean_train_dataset_with_transform)
        hook.remove()
