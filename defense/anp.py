...
class anp(defense):
    ...
    def set_result(self, result_file):
        ...
        save_path = 'record/' + result_file + '/defense/anp/' + f'{self.args.yaml_name}/'
    ...
    def mitigation(self):
        ...
        train_tran = get_transform(self.args.dataset, *([self.args.input_height,self.args.input_width]) , train = True)
        data_set_clean = self.get_reserved_data(train_tran, reserved_type = self.args.reserved_type, ratios = None)
